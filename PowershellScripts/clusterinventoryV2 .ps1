...
$VmInventory = ForEach ($VM in ($Cluster | Get-VM | Sort-Object -Property Name)){
      ForEach ($HardDisk in ($VM | Get-HardDisk | Sort-Object -Property Name)){
        ...
        @{N="Portgroups";E={[string]::Join(',',($vm.NetworkAdapters | Select -ExpandProperty NetworkName))}}
        @{N="VLANID";E={$vm.spec.VLANID}},
...
$clusterInfo | Export-Csv -NoTypeInformation -UseCulture -Path "$clusterName Info.csv" 
