$allLines = @()
 Get-VM | `
  ForEach-Object {
    ...
    $Report = "" | Select-Object VMname,ClusterName,ESXname,MemoryGB,vCPUcount,vNICcount,VMDKname,VmdkSizeGB,TotalVmdkSizeGB,DatastoreName,RDMPath,VLANid,Portgroup,GuestOS
  ...
  $allLines | Export-Csv "C:\DETVMreport.csv" -NoTypeInformation
