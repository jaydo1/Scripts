...
$ClusterReport | Export-Csv -NoTypeInformation -UseCulture -Path "$clustername-ClusterReport.csv"
$HostReport | Export-Csv –NoTypeInformation -useCulture -Path "$clustername-HostReport.csv" 
$VmInventory | Export-Csv -NoTypeInformation -UseCulture -Path "$clustername-VmInventory.csv"

ConvertCSV-ToExcel -inputfile @("$clustername-ClusterReport.csv","$clustername-HostReport.csv","$clustername-VmInventory.csv") -output "$clustername-Report.xlsx" 